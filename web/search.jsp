    ...
    <body>
        <%@include file="all_component/navbar.jsp"%>
         <div class="container-fluid" style="background-color:white">
            <h3 class="text-center">All Search Tour</h3><!-- comment -->
            <div class="row ">
                
                    <%
                    User u = (User) request.getSession().getAttribute("userobj");
                    List<Tour> recentList = (List<Tour>) session.getAttribute("listTour");
                    for(Tour b : recentList){
                    %>
                     <div class="col-md-3 ">
                    <div class="card col-hover">
                        <div class="card-body text-center">
                            <img alt="tour" src="tour/<%=b.getPhoto()%>" style="width: 80%;height: 200px" class="img-thumblin" >
                            <p><%=b.getName()%></p>
                            <p><%=b.getAuthor()%></p>
                            <%
